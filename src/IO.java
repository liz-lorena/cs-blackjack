...
public class IO
{
  private static BufferedReader kb = new BufferedReader(new java.io.InputStreamReader(System.in));
  ...
  public static boolean openFile(String filename) {
    try { fio = new BufferedReader(new java.io.FileReader(filename));
  ...
  public static String readLine() {
    ...
    try {
      return fio.readLine(); } catch (IOException e) {}
    return null;
  }
